declare module 'express' {
  ...
  export interface Response extends ServerResponse { json(data: any): Response; status(code: number): Response; send(data?: any): Response; setHeader(name: string, val: string): void; }
